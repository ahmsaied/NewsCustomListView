...
public class FoxNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new FoxNewsActivity.ReadJSON().execute("https://newsapi.org/v2/top-headlines?sources=fox-news&apiKey=d0eccea4ff764654b4f7b65b1dc2a664");
            }
        });
    }
