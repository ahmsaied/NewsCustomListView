...
public class TheWashingtonPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new TheWashingtonPostActivity.ReadJSON().execute("https://newsapi.org/v2/top-headlines?sources=the-washington-post&apiKey=d0eccea4ff764654b4f7b65b1dc2a664");
            }
        });
    }
