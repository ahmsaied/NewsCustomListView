...
public class CBSNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                new CBSNewsActivity.ReadJSON().execute("https://newsapi.org/v2/top-headlines?sources=cbs-news&apiKey=d0eccea4ff764654b4f7b65b1dc2a664");
            }
        });
    }
